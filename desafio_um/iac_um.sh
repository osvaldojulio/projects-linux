...
useradd osvaldo -m -s /bin/bash -p $(openssl passwd -crypt Senha1234) -G GRP_ADM

useradd debora -m -s /bin/bash -p $(openssl passwd -crypt Senha1234) -G GRP_VEN
useradd afonso -m -s /bin/bash -p $(openssl passwd -crypt Senha1234) -G GRP_VEN
useradd roberto -m -s /bin/bash -p $(openssl passwd -crypt Senha1234) -G GRP_VEN

useradd zara -m -s /bin/bash -p $(openssl passwd -crypt Senha1234) -G GRP_SEC
